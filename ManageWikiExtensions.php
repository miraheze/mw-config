...
$wgManageWikiExtensions = [
	...
	'3d' => [
		...
		'install' => [
			'settings' => [
				'wgFileExtensions' => array_merge( $wgConf->get( 'wgFileExtensions', $wi->dbname ), [ 'stl' ] ),
			],
		],
	...
	'semanticmediawiki' => [
		...
		'help' => '<br/> Permanently "experimental" and may be removed with little to no prior notice. WARNING: Disabling this extension after it\'s already been enabled will clear all SemanticMediaWiki database tables as well. <br/><b>Note: <a href="https://meta.miraheze.org/wiki/Special:MyLanguage/Stewards" target="_blank">Stewards</a>, please ensure that a member of the <a href="https://meta.miraheze.org/wiki/Special:MyLanguage/Tech:SRE_Volunteers" target="_blank">Site Reliability Engineering</a> team is available and not mobile in order to run the following MediaWiki maintenance script: <code>mwscript extensions/SemanticMediaWiki/setupStore.php</code> on every MediaWiki server after enabling this.</b>',
