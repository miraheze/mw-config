...
$wgManageWikiExtensions = [
	...
	'cargo' => [
		...
		'help' => 'Consider using [[weirdgloop:Extension:Bucket|Bucket]] instead: it is an unrestricted extension. If you prefer a wikitext interface, you may find [[mh:bucket:Module:Bucket|Module:Bucket]]\'s Cargo-like syntax convenient. <br>Stewards: it is recommended to not enable this extension on wikis with more than <b>50,000</b> pages. This includes all pages, <b>not</b> only content pages. Please use discretion.',
