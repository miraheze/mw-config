...
$wgManageWikiExtensions = [
		...
		'wikibaserepository' => [
			...
			'install' => [
				'sql' => [
					'wb_changes' => "$IP/extensions/Wikibase/repo/sql/archives/changes.sql",
					'wb_changes_dispatch' => "$IP/extensions/Wikibase/repo/sql/archives/changes_dispatch.sql",
					'wb_changes_subscription' => "$IP/extensions/Wikibase/repo/sql/archives/changes_subscription.sql",
					'wbt_item_terms' => "$IP/extensions/Wikibase/repo/sql/term_store.sql",
					'wb_terms' => "$IP/extensions/Wikibase/repo/sql/Wikibase.sql",
					'wbt_term_in_lang' => "$IP/extensions/Wikibase/repo/sql/term_store.sql",
					'wbt_text_in_lang' => "$IP/extensions/Wikibase/repo/sql/term_store.sql",
					'wbt_text' => "$IP/extensions/Wikibase/repo/sql/term_store.sql",
					'wbt_type' => "$IP/extensions/Wikibase/repo/sql/term_store.sql",
					'wb_property_info' => "$IP/extensions/Wikibase/repo/sql/wb_property_info.sql",
					'wbt_property_terms' => "$IP/extensions/Wikibase/repo/sql/term_store.sql",
				],
				'namespaces' => [
					'Item' => [
						'id' => 860,
