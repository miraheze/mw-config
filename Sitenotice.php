...
if ( !$wmgSiteNoticeOptOut ) {
	...
	function onSiteNoticeAfter( &$siteNotice, $skin ) {
		...
		$siteNotice .= <<<EOF
			...
			<td style="font-size:125%"><div data-nosnippet>Miraheze SRE will be performing Database Maintenance at 2100 UTC on August 19th. You will not be able to edit for up to 30 minutes. Please save your edits 5 minutes before.</div></td>
			</tr></tbody></table>
		EOF;
	}
}
