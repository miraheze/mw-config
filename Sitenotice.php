...
if ( $wgDisableSearchUpdate ?? false ) {
	$wgHooks['SiteNoticeAfter'][] = 'onSiteNoticeAfter';

	function onSiteNoticeAfter( &$siteNotice, $skin ) {
		$siteNotice .= <<<EOF
			<table class="wikitable" style="text-align:center;"><tbody><tr>
			<td style="font-size:125%"><div data-nosnippet>Your wiki is currently being migrated to ElasticSearch. We've disabled updates so new pages won't show up in search while we migrate. The new search experience will be available soon./div></td>
			</tr></tbody></table>
		EOF;
	}
}
