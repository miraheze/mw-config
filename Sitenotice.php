...
function onSiteNoticeAfter( &$siteNotice, $skin ) {
	...
	$siteNotice .= <<<EOF
			...
			<td>Regarding the migration issues, system administrators are working on fixing remnants of the rollback. All wikis can be read and edited without issues now.
