...
if ( $wmgEditingMatrix ) {
	...
	if ( isset( $mhEM['anon'] ) && $mhEM['anon'] ) { // Disables anonymous editing if set to true
		$wgGroupPermissions['*']['edit'] = false;
		$wgGroupPermissions['*']['createpage'] = false;
	}

	if ( isset( $mhEM['user'] ) && $mhEM['user'] ) { // Disables editing by logged in users if set to true
		$wgGroupPermissions['user']['edit'] = false;
		$wgGroupPermissions['user']['createpage'] = false;
	}

	if ( isset( $mhEM['editor'] ) && $mhEM['editor'] ) { // Creates an 'editor' group that is addable by bureaucrats/sysops if set to true
	...
	if ( isset( $mhEM['sysop'] ) && $mhEM['sysop'] ) { // Allows sysops to edit if $mhEM['anon'] and $mhEM['user'] are both set to true
		$wgGroupPermissions['sysop']['edit'] = true;
		$wgGroupPermissions['sysop']['createpage'] = true;
	}
	
	if ( isset( $mhEM['bureaucrat'] ) && $mhEM['bureaucrat'] ) { // Allows bureaucrats to edit if $mhEM['anon'] and $mhEM['user'] are both set to true
