...
if ( $wgDBname === 'allthetropeswiki' || $wgDBname === 'metawiki' || $wgDBname === 'loginwiki' || $wgDBname === 'nonciclopediawiki' || $wgDBname === 'anotheredenwiki' || $wgDBname === 'sidemwiki') {
...
if ( $wgDBname === 'allthetropeswiki' || $wgDBname === 'nonciclopediawiki' || $wgDBname === 'nonsensopediawiki' ) {
