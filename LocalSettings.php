...
$wgConf->settings = array(
	...
	'wmgCreateWikiSQLfiles' => array(
		'default' => array(
			...
			"$IP/extensions/ArticleFeedbackv5/sql/archive.sql",
			"$IP/extensions/ArticleFeedbackv5/sql/claimed_user.sql",
			"$IP/extensions/ArticleFeedbackv5/sql/discuss.sql",
			"$IP/extensions/ArticleFeedbackv5/sql/inappropriate.sql",
			"$IP/extensions/ArticleFeedbackv5/sql/index_contribs.sql",
			"$IP/extensions/ArticleFeedbackv5/sql/index_page.sql",
			"$IP/extensions/ArticleFeedbackv5/sql/index_user_data.sql",
			"$IP/extensions/ArticleFeedbackv5/sql/noaction.sql",
			"$IP/extensions/ArticleFeedbackv5/sql/offload_large_feedback.sql",
			"$IP/extensions/ArticleFeedbackv5/sql/remove_legacy.sql",
			"$IP/extensions/ArticleFeedbackv5/sql/userip_length.sql",
