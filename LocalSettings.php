...
$wgConf->settings += [
	...
	'wgCreateWikiCannedResponses' => [
		'default' => [
			...
			'Decline reasons' => [
				...
				'Invalid subdomain' => 'The scope and purpose of the wiki seem clear enough. However, your requested subdomain is either invalid, is too generic, conveys a Miraheze affiliation, or suggests the wiki is an English language or multilingual wiki when it is not. Please change it to something that better reflects your wiki\'s purpose and scope. Thank you.',
				'Prohibited sitename/subdomain (obscene wording)' => 'The scope and purpose of the wiki seem clear enough. However, the requested wiki name or subdomain is in violation of our Content Policy which prohibits obsence wording in wiki names and subdomains. Please change it to something that is better. Thank you.',
				...
				'Database exists (wiki undeleted)' => 'The selected wiki database name already exists and the wiki has been reopened after previously being closed. Wikis are only deleted after 6 months of inactivity. Please reach out to any local bureaucrat to request permissions if you require them. If bureaucrats are not active on the wiki, please start a local election and request evaluation on the Stewards\' noticeboard. Thank you.',
				...
				'Duplicate request (approved)' => 'Declining as a duplicate request of a request that has already been approved. Please see the original request for further information. Also, please do not submit duplicate requests in the future. Thank you.',
				'Duplicate request (denied)' => 'Declining as a duplicate request of a request that has already been denied. Please see the original request for further information. Also, please do not submit duplicate requests in the future. Thank you.',
				'Duplicate request (other wiki request)' => 'Declining as a duplicate request, which requires more information to be approved. Please do not edit this request and instead go back into your original request and add relevant information there. Also, please do not submit duplicate requests in the future. Thank you.',
				...
				'Vandal request' => 'Declining as this wiki request is a product of vandalism.',
				'Troll request' => 'Declining as this wiki request is a product of trolling.',
				...
				'Content Policy (illegal UK activity)' => 'Declining per Content Policy provision, "Miraheze does not host any content that is illegal in the United Kingdom." Thank you for understanding. If you believe this decline reason was used incorrectly, please address this with the declining wiki creator on their user talk page first before escalating your concern to the Stewards\' noticeboard or other venues. Thank you.',
				'Content Policy (makes it difficult for other wikis)' => 'Declining per Content Policy provision, "A wiki must not create problems which make it difficult for other wikis." Thank you for understanding. If you believe this decline reason was used incorrectly, please address this with the declining wiki creator on their user talk page first before escalating your concern to the Stewards\' noticeboard or other venues. Thank you.',
				'Content Policy (no anarchy wikis)' => 'Declining per Content Policy provision, "Miraheze does not host wikis that operate on the basis of an anarchy system (i.e. no leadership and no rules)." Thank you for understanding. If you believe this decline reason was used incorrectly, please address this with the declining wiki creator on their user talk page first before escalating your concern to the Stewards\' noticeboard or other venues. Thank you.',
				...
				'Content Policy (toxic communities)' => 'Declining per Content Policy provision, "Miraheze does not host wikis where the community has developed in such a way as to be characterised as toxic." Thank you for your understanding. If you believe this decline reason was used incorrectly, please address this with the declining wiki creator on their user talk page first before escalating your concern to the Stewards\' noticeboard or other venues. Thank you.',
				...
				'Content Policy (Wikimedia-like wikis/forks)' => 'Declining per Content Policy provision, "Direct forks and forks where a substantial amount of content is copied from a Wikimedia project are not allowed." Thank you for your understanding. If you believe this decline reason was used incorrectly, please address this with the declining wiki creator on their user talk page first before escalating your concern to the Stewards\' noticeboard or other venues. Thank you.',
				'Content Policy (reception wiki)' => 'Declining following a community decision that new reception wikis are prohibited across the Miraheze platform. A reception wiki is defined as a wiki that categorizes a defined set of things (i.e. a group of people, places, or items) as good/bad through a series of pointers. Thank you for your understanding.',
	...
	'wgRightsText' => [
		...
		'revitwiki' => '©2013-2023 by Lionel J. Camara (All Rights Reserved)',
