	...
	'wgCreateWikiCannedResponses' => [
		'default' => [
			...
			'Decline reasons' => [
				...
				'Invalid sitename/subdomain (obsence wording)' => 'The scope and purpose of the wiki seem clear enough. However, the requested wiki name or subdomain is in violation of our Content Policy which prohibits obsence wording in wiki names and subdomains. Please change it to something that better. Thank you.',
				...
				'Content Policy (toxic communities)' => 'Declining per Content Policy provision, "Miraheze does not host wikis where the community has developed in such a way as to be characterized as toxic." Thank you for your understanding.',
				...
				'Content Policy (Wikimedia-like wikis/forks)' => 'Declining per Content Policy provision, "Direct forks and forks where a substantial amount of content is copied from a Wikimedia project are also not allowed." Thank you for your understanding.',
