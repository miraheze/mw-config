...
$wgConf->settings += [
	...
	'wgCreateWikiSQLFiles' => [
		'default' => [
			"{$wi->defaultPath}/sql/mysql/tables-generated.sql",
			"{$wi->defaultPath}/extensions/AbuseFilter/db_patches/mysql/tables-generated.sql",
			"{$wi->defaultPath}/extensions/AntiSpoof/sql/mysql/tables-generated.sql",
			"{$wi->defaultPath}/extensions/BetaFeatures/sql/tables-generated.sql",
			"{$wi->defaultPath}/extensions/CheckUser/schema/mysql/tables-generated.sql",
			"{$wi->defaultPath}/extensions/DataDump/sql/data_dump.sql",
			"{$wi->defaultPath}/extensions/Echo/sql/mysql/tables-generated.sql",
			"{$wi->defaultPath}/extensions/GlobalBlocking/sql/mysql/tables-generated-global_block_whitelist.sql",
			"{$wi->defaultPath}/extensions/Linter/sql/mysql/tables-generated.sql",
			"{$wi->defaultPath}/extensions/MediaModeration/schema/mysql/tables-generated.sql",
			"{$wi->defaultPath}/extensions/OAuth/schema/mysql/tables-generated.sql",
			"{$wi->defaultPath}/extensions/RottenLinks/sql/rottenlinks.sql",
			"{$wi->defaultPath}/extensions/UrlShortener/schemas/mysql/tables-generated.sql",
		],
	],
