...
$wgConf->settings = array(
	...
	'wgReadOnly' => array(
		'default' => false,
		'hellointernetwiki' => 'Renaming wiki',
	),
	'wgSharedDB' => array(
		'default' => 'metawiki',
	),
...
//	),
	...
	'wgFileExtensions' => array(
		...
		'+sdiywiki' => array( 'pdf', 'mid', 'mp3', 'flac', 'svg', 'fpd', 'oga', 'ogv'),		
	...
	'wgRightsPage' => array(
		...
		'kstartupswiki' => 'Project:ì €ìž‘ê¶Œ',
	...
	'wgRightsText' => array(
		...
		'coldbloodedwiki' => 'í¬ë¦¬ì—ì´í‹°ë¸Œ ì»¤ë¨¼ì¦ˆ ì €ìž‘ìží‘œì‹œ-ë™ì¼ì¡°ê±´ë³€ê²½í—ˆë½ 4.0 êµ­ì œ ë¼ì´ì„ ìŠ¤',
		...
		'kstartupswiki' => 'í¬ë¦¬ì—ì´í‹°ë¸Œ ì»¤ë¨¼ì¦ˆ ì €ìž‘ìží‘œì‹œ-ë¹„ì˜ë¦¬-ë³€ê²½ê¸ˆì§€ 4.0 êµ­ì œ ë¼ì´ì„ ìŠ¤',
	...
	'wgExtraNamespaces' => array(
		...
		'uncyclopediawiki' => array(
			NS_PSEUDO_NEWS => 'ä¼ªåŸºæ–°é—»',
			NS_PSEUDO_NEWS_TALK => 'ä¼ªåŸºæ–°é—»è°ˆ',
			NS_PSEUDO_BASE_DICTIONARY => 'ä¼ªåŸºè¯å…¸',
			NS_PSEUDO_BASE_DICTIONARY_TALK => 'ä¼ªåŸºè¯å…¸è°ˆ',
			NS_PSEUDO_BASE_LIBRARY => 'ä¼ªåŸºæ–‡åº“',
			NS_PSEUDO_BASE_LIBRARY_TALK => 'ä¼ªåŸºæ–‡åº“è°ˆ',
			NS_PSEUDO_BASE_MUSIC => 'ä¼ªåŸºéŸ³ä¹',
			NS_PSEUDO_BASE_MUSIC_TALK => 'ä¼ªåŸºéŸ³ä¹è°ˆ',
		),
		'uwswiki' => array(
 		 	NS_WNS2 => 'WNS2',
	...
	'+wgNamespaceAliases' => array(
		...
		'+bigforestwiki' => array(
			...
			'ì±…' => NS_SOURCE,
			'ê²Œìž„' => NS_GAME,
			'ê·¸ë¦¼íŒ' => NS_PICTUREBOARD,
			'ìž‘ì€ìˆ²' => NS_TINYFOREST,
			"í† " => NS_TALK,
			"ì‚¬í† " => NS_USER_TALK,
			"ìˆ²" => NS_PROJECT,
			"í°ìˆ²" => NS_PROJECT,
			"ìˆ²í† " => NS_PROJECT_TALK,
			"íŒŒ" => NS_FILE,
			"í‹€í† " => NS_TEMPLATE_TALK,
			"ë¶„" => NS_CATEGORY,
			"ë¶„í† " => NS_CATEGORY_TALK,
			"ë‰´ìŠ¤" => NS_NEWSLINK,
		),
		'+bpwiki' => array(
		...
		'+tmewiki' => array(
			...
			'CatÃ©gorie' => NS_CATEGORY,
			'CategorÃ­a' => NS_CATEGORY,
			'Archivo' => NS_FILE,
			'MÃ³dulo' => WMG_NS_MODULE,
			'Especial' => NS_SPECIAL,
			'Espesyal' => NS_SPECIAL,
			'SpecialaÄµo' => NS_SPECIAL,
			'Specialis' => NS_SPECIAL,
			'ÐšÐ°Ñ‚ÐµÐ³Ð¾Ñ€Ð¸Ñ' => NS_CATEGORY,
			'ÐŸÐ¾Ñ€Ñ‚Ð°Ð»' => NS_PORTAL,
			'Ð¡Ð»ÑƒÐ¶ÐµÐ±Ð½Ð°Ñ' => NS_SPECIAL,
			'Kuva' => NS_FILE,
			'Luokka' => NS_CATEGORY,
			'Dosiero' => NS_FILE,
			...
			'PredefiniÃ§Ã£o' => NS_TEMPLATE,
			'Imagem' => NS_IMAGE,
			'ç”»åƒ' => NS_FILE,
			'Kategorie' => NS_CATEGORY,
			'Kategoriebespreking' => NS_CATEGORY_TALK,
			'LÃªer' => NS_FILE,
			'LÃªerbespreking' => NS_FILE_TALK,
			'Plantilla' => NS_TEMPLATE,
			'Åœablono' => NS_TEMPLATE,
			'Ayuda' => NS_HELP,
	...
	'wgLogo' => array(
		...
		'csnimsbordeauxwiki' => "//$wmgUploadHostname/csnimsbordeauxwiki/1/1a/Logo_Ã©quipe_CSN_IMS_Bordeaux.png",
		...
		'thireswiki' => "//$wmgUploadHostname/thireswiki/9/9e/í‹°ë ˆìŠ¤_ìœ„í‚¤_ë¡œê³ .png",
		...
		'wikibregiswiki' => "//$wmgUploadHostname/wikibregiswiki/1/1a/Logo_wiki_brÃ©gis.jpg",
