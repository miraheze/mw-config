...
$wi->config->settings += [
	...
	'wgCreateWikiCannedResponses' => [
		'default' => [
			...
			'Database exists (wiki still active)' => 'Wiki database name and subdomain already exists. Please visit the local wiki and reach out to a local bureaucrat to edit and/or request any permissions you may require. If bureaucrats are not active on the wiki after a reasonable period of time, please see Stewards\' noticeboard. Thanks.',
			'Database exists (wiki already deleted)' => 'Wiki database name and subdomain already exists, but had been deleted in accordance with Dormancy Policy. I will request a Steward to undelete it for you. When it has been undeleted an reopened, please visit the local wiki and ensure you make at least one edit or log action every 45 days. Wikis are only deleted after 6 months of complete inactivity; if you require a Dormancy Policy exemption, you should review the policy and request it once you wiki has at least 40-60 content pages. Thank you.',
			'Duplicate request' => 'Declining as a duplicate request, which has needs more information. Please do not edit this request and instead go back into your original request. Also, please do not submit duplicate requests. Thanks.',
			'Content Policy (unsubstantiated insult)' => 'Declining per Content Policy provision, "Miraheze does not host wikis with the sole purpose to spread unsubstantiated insult, hate or rumours against a person or group of people."',
			'Content Policy (makes it difficult for other wikis)' => 'Declining per Content Policy provision, "A wiki must not create problems which make it difficult for other wikis."',
