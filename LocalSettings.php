	...
	'wgCreateWikiCannedResponses' => [
		'default' => [
			'Approval reasons' => [
				...
				'Okay request' => 'Okay-ish. Description doesn\'t meet our requirements, but in this case the sitename, URL, and categorization suggest this is a wiki that would follow the Content Policy made clear by the preceding fields, and it is conditionally approved as such. Please be advised that if your wiki deviates too much from this approval, remedial action can be taken by a Steward which includes wiki closure and potential revocation of wiki requesting privileges, if necessary. Please ensure your wiki complies with all aspects of Content Policy and Code of Conduct at all times. Thank you.',
				'Categorized as private' => 'The purpose and scope of your wiki is clear enough. Please ensure your wiki complies with all aspects of the Content Policy and Code of Conduct at all times or it may be closed. Please also note that I have categorized your wiki as "Private". Thank you.',
			],
			'Decline reasons' => [
				...
				'Invalid sitename/subdomain (obscene wording)' => 'The scope and purpose of your wiki seem clear enough; however, the requested wiki name or subdomain is in violation of our Content Policy, which prohibits obsence wording in wiki names and subdomains. Please change it to something that is appropriate. Thank you.',
				...
				'Duplicate request (already approved)' => 'Declining as a duplicate of a request that has already been approved. Any changes to your wiki should be made via ManageWiki locally or requested on the Stewards\' noticeboard or Phabricator whenever unavailable via ManageWiki. Thank you.',
