...
$wi->config->settings += [
	...
	'wgCreateWikiCannedResponses' => [
		'default' => [
			...
			'Needs a better subdomain' => 'The scope and purpose of the wiki sound good enough. However, your requested subdomain is not very obvious. Please change it to something that better reflects your wiki\'s purpose. Thank you.',
			...
			'Duplicate wiki' => 'We already have a wiki that covers this topic. Please contribute to that wiki instead. Thank you.',
		],
	],
