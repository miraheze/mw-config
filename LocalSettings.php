...
$wgSpecialPages['RequestWikiQueue'] = DisabledSpecialPage::getCallback( 'RequestWikiQueue', 'Due to current issues with wiki creations, all wiki requests are currently on hold. We are working to resolve the issues ASAP and apologise for the inconvenience. They should hopefully be back soon' );
