...
$wgManageWikiSettings = [
	...
	'wgCitizenThemeDefault' => [
		...
		'section' => 'styling',
		'help' => 'Soft-deprecated: this keeps working until Citizen 4, but the preferred place is the <code>skin-theme</code> default in [[MediaWiki:Citizen-preferences.json]], which wins when both are set. Default theme of the Citizen skin. Accepts "auto", "light", "dark", or any theme value such as "black" or a wiki-defined theme. The Black theme and wiki-defined themes need the Citizen 4 preview to render correctly.',
		'requires' => [],
	],
	...
	'wgCitizenEnableDrawerSiteStats' => [
		'name' => 'Citizen Enable Drawer Site Stats',
		'from' => 'citizen',
		'type' => 'check',
		'overridedefault' => true,
		'section' => 'styling',
		'help' => 'Enables the site statistics in drawer menu',
		'requires' => [],
	],
	'wgCitizenGlobalToolsPortlet' => [
		...
		'overridedefault' => '',
		'section' => 'styling',
		'help' => 'Name of the [[MediaWiki:Sidebar]] menu to move the "Upload file" link into, such as "navigation". Leave empty to use the first menu. A name that does not match a menu creates a new one.',
		'requires' => [],
	],
	'wgCitizenShowPageTools' => [
		...
		'overridedefault' => 1,
		'section' => 'styling',
		'help' => 'Who can see the page tools menu. "true": everyone. "login": logged-in users. "permission-edit": users who can edit the page.',
		'requires' => [],
	],
	'wgCitizenThemeColor' => [
	...
	'wgCitizenEnableARFonts' => [
		'name' => 'Citizen Enable AR fonts',
		'from' => 'citizen',
		'type' => 'check',
		'overridedefault' => false,
		'section' => 'styling',
		'help' => 'Enable included Noto Naskh Arabic for wikis that serve Arabic',
		'requires' => [],
	],
	...
	'wgCitizenTableOfContentsCollapseAtCount' => [
		...
		'maxint' => 9999,
		'overridedefault' => 28,
		'help' => 'The minimum number of headings required to collapse all headings in the sticky table of contents by default.',
		'section' => 'styling',
		'requires' => [],
	],
	...
	'wgCitizenEnablePreferences' => [
		'name' => 'Citizen Enable Preferences',
		'from' => 'citizen',
		'type' => 'check',
		'overridedefault' => true,
		'section' => 'styling',
		'help' => 'Enables the preferences panel, where readers can change display settings such as the theme and font size.',
		'requires' => [],
	],
	'wgCitizenEnableManifest' => [
		'name' => 'Citizen Enable Manifest',
		'from' => 'citizen',
		'type' => 'check',
		'overridedefault' => true,
		'section' => 'styling',
		'help' => 'Enables the web app manifest, which lets users install the wiki as an app on their device. Turn this off if the PWA extension is enabled, as it adds its own manifest.',
		'requires' => [],
	],
	'wgCitizenPreview' => [
		...
		'overridedefault' => 0,
		'section' => 'styling',
		'help' => 'Puts the whole wiki on the Citizen 4 preview: the new color system, the Black theme and wiki-defined themes. Preview features may still change before Citizen 4 is released. To try it in your own browser first, add <code>?citizenpreview=4</code> to a page URL.',
		'requires' => [],
	],
