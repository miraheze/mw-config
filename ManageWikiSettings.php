...
$wgManageWikiSettings = [
	...
	'wgVectorResponsive' => [
		'name' => 'Responsive Vector',
		'from' => 'mediawiki',
		'type' => 'check',
		'overridedefault' => false,
		'section' => 'styling',
		'help' => 'Whether to display Responsive Vector by default?'
		'requires' => [],
	],
	'wgVectorDefaultSkinVersion' => [
		'name' => 'Vector Default Version',
		'from' => 'mediawiki',
		'type' => 'integer',
		'minint' => 1,
		'maxint' => 2,
		'overridedefault' => 1,
		'section' => 'styling',
		'help' => 'The default version of the Vector in use: 1 means normal (not Responsive) and 2 means Responsive version. If <code>wgVectorResponsive</code> is set to true, you need Vector version 2.',
		'requires' => [],
	],
	'wgVectorLanguageInHeader' => [
		'name' => 'Languages In Header In Vector',
		'from' => 'mediawiki',
		'type' => 'check',
		'overridedefault' => false,
		'section' => 'styling',
		'help' => 'Are language links displayed in the header in Responsive Vector?'
		'requires' => [],
	],
	'wgVectorIsSearchInHeader' => [
		'name' => 'Search Bar In Header In Vector',
		'from' => 'mediawiki',
		'type' => 'check',
		'overridedefault' => false,
		'section' => 'styling',
		'help' => 'Is the search bar displayed in the header on the left in the Responsive Vector?',
		'requires' => [],
	],
