...
$wgManageWikiSettings = [
	...
	'wmgWebChatClient' => [
		...
		'type' => 'list',
		'options' => [
			'FreenodeChat' => 'freenodeChat',
			'Mibbit' => 'Mibbit',
			// Empty string means that this config will basically return false
			'' => '',
		],
		'overridedefault' => '',
		'section' => 'chat',
		'help' => 'Which web chat client to use, "freenodeChat" is required when connecting to freenode, but "Mibbit" can be used for other.',
	],
