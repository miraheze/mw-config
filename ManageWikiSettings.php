...
$wgManageWikiSettings = [
	...
	'wmgGalleryOptionsImagesPerRow' => [
		'name' => 'Default Gallery Options - Images Per Row',
		'from' => 'mediawiki',
		'global' => true,
		'type' => 'integer',
		'minint' => 0,
		'maxint' => 9999,
		'overridedefault' => 0,
		'help' => 'Default number of images per row in the gallery. Settings this to 0 makes the gallery adapt to screensize.',
		'section' => 'styling',
		'requires' => [],
	],
	'wmgGalleryOptionsImageWidth' => [
		'name' => 'Default Gallery Options - Image Width',
		'from' => 'mediawiki',
		'global' => true,
		'type' => 'integer',
		'minint' => 0,
		'maxint' => 9999,
		'overridedefault' => 120,
		'help' => 'Default width in pixels of the cells containing images in galleries.',
		'section' => 'styling',
		'requires' => [],
	],
	'wmgGalleryOptionsImageHeight' => [
		'name' => 'Default Gallery Options - Image Height',
		'from' => 'mediawiki',
		'global' => true,
		'type' => 'integer',
		'minint' => 0,
		'maxint' => 9999,
		'overridedefault' => 120,
		'help' => 'Default height in pixels of the cells containing images in galleries.',
		'section' => 'styling',
		'requires' => [],
	],
	'wmgGalleryOptionsShowBytes' => [
		'name' => 'Default Gallery Options - Show File Size in Bytes',
		'from' => 'mediawiki',
		'global' => true,
		'type' => 'check',
		'overridedefault' => true,
		'help' => 'Controls whether to show the file size in bytes in categories.',
		'section' => 'styling',
		'requires' => [],
	],
	'wmgGalleryOptionsShowDimensions' => [
		'name' => 'Default Gallery Options - Show Image Dimensions',
		'from' => 'mediawiki',
		'global' => true,
		'type' => 'check',
		'overridedefault' => true,
		'help' => 'Controls whether to show the image dimensions in categories.',
		'section' => 'styling',
		'requires' => [],
	],
	'wmgGalleryOptionsMode' => [
		'name' => 'Default Gallery Options - Mode',
		'from' => 'mediawiki',
		'global' => true,
		'type' => 'list',
		'options' => [
			...
			'No lines' => 'nolines',
			'Packed' => 'packed',
			'Packed with captions overlaying the images' => 'packed-overlay',
			'Packed with captions appearing on hover' => 'packed-hover',
			'Slideshow' => 'slideshow',
		],
		'overridedefault' => 'traditional',
		'help' => 'Default gallery mode. See [[mw:Help:Images#mode parameter|documentation]] for more information on available options.',
		'section' => 'styling',
		'requires' => [],
	],
