...
$wgManageWikiSettings = [
	...
	'egChameleonLayoutFile' => [
		...
		'type' => 'list',
		'options' => [
			'standard' => '/chameleon/layouts/standard.xml',
			'navhead' => '/chameleon/layouts/navhead.xml',
			'fixedhead' => '/chameleon/layouts/fixedhead.xml',
			'stickyhead' => '/chameleon/layouts/stickyhead.xml',
			'clean' => '/chameleon/layouts/clean.xml',
		],
		'overridedefault' => '/chameleon/layouts/standard.xml',
		'section' => 'styling',
