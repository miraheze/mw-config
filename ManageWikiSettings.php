...
$wgManageWikiSettings = [
	...
	'wgEvelutionLeftPersonalLinks' => [
		...
		'overridedefault' => false,
		'section' => 'styling',
		'help' => 'Changes the alignment of the .upper-links container in the personal links from <code>center</code> to <code>left</code>.',
		'requires' => [],
	],
	...
	'wgEvelutionDisableRightRail' => [
		...
		'overridedefault' => false,
		'section' => 'styling',
		'help' => 'Disables the right rail that appears on appears on all pages (except Special Pages, File Pages, Main Page and MediaWiki Pages).',
		'requires' => [],
	],
	...
	'wgEvelutionForceFullWidth' => [
		'name' => 'Force Evelution layout to be always full width',
		'from' => 'evelution',
		'type' => 'check',
		'overridedefault' => false,
		'section' => 'styling',
	...
	'wgEvelutionChangeMessageBoxesToBanners' => [
		'name' => 'Convert Evelution Message Boxes to Banner Notifications',
		'from' => 'evelution',
		'type' => 'check',
		'overridedefault' => false,
		'section' => 'styling',
		'help' => 'All errorboxes, warningboxes, successboxes and messageboxes except the ones with the <code>noconvert</code> class will be converted into banner notifications',
		'requires' => [],
	],
