...
if ( !in_array( $wgDBname, $wgLocalDatabases ) ) {
    ...
    <hr>
    <div><div style="float: left;"><p>nginx - MediaWiki</p></div><div style="float: right;"><img src="https://static.miraheze.org/metawiki/7/7e/Powered_by_Miraheze.png" alt="Powered by Miraheze.org"></div></div>
EOF;
    die( 1 );
}
