...
<div class="container">
  <!-- Jumbotron -->
  <div class="jumbotron">
    <h1><img src="//static.miraheze.org/metawiki/3/35/Miraheze_Logo.svg"> Wiki not Found</h1>
        ...
        <script type="text/javascript">
            function checkSite(){
              var currentSite = window.location.hostname;
                window.location = "http://meta.miraheze.org";
            }
        </script>
    </p>
  </div>
  ...
  <div class="body-content">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <p class="lead">If you're the wiki owner</p>
